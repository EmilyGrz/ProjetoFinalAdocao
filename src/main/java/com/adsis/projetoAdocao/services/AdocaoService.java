...
public class AdocaoService {
    ...
    public Adocao cadastrar(AdocaoRequestDTO dto){
        ...
        Adotante adotante = adotanteRepository.findById(dto.getIdAdotante()).orElseThrow();
    ...
    public void excluir(Long id){
        ...
        Animal animal = animalRepository.findById(adocao.getAnimal().getId()).orElseThrow(() -> new NaoEncontradoException("animal não encontrado para atualizar"));
    ...
    public void alterarStatus(Long id, StatusAdocao novoStatus) {
        Adocao adocao = adocaoRepository.findById(id).orElseThrow();
        Animal animal = animalRepository.findById(adocao.getAnimal().getId()).orElseThrow();
